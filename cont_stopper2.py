...
"""This class is intended for continuing training beyond the initial HP tuning, so it will be more forgiving."""
        ...
        if trial_id in self.trials:
            ...
            # Else the deque is full so we can start analyzing stop criteria
                ...
                if total_iters > self.required_min_iters:
                    ...
                    # Stop if mean and max rewards haven't significantly changed in recent history and we have an acceptable mean
                    ...
                    if avg_of_mean < self.failure_avg_threshold:
                        ...
                        # If the max reward is below failure threshold and not climbing significantly, then stop as a failure
                        ...
                        if slope_max < 0.0:
                            ...
                            elif self._get_slope(self.trials[trial_id]["mean_rewards"]) < 0.0:
