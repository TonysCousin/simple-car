...
"""This is for continued tuning from an existing checkpoint."""
...
def main(argv):
    ...
    explore_config["scale_timesteps"]           = 800000  #tune.choice([100000, 400000]) #was 900k
    params["exploration_config"] = explore_config
    ...
    tuner = tune.Tuner.restore(checkpoint)
    print("\n///// Tuner created from checkpoint {}.\n".format(checkpoint))
